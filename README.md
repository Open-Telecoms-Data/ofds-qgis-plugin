...
- by downloading and installing the zip file from the [GitHub repository](https://github.com/Open-Telecoms-Data/ofds-qgis-plugin)
 
See the QGIS documentation for [full guidance](https://docs.qgis.org/latest/en/docs/user_manual/plugins/plugins.html).
